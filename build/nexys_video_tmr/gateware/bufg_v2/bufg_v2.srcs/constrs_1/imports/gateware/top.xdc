...
set_property IOSTANDARD LVCMOS33 [get_ports hdmi_out_scl]
 ## hdmi_out:0.sda
set_property LOC V3 [get_ports hdmi_out_sda]
set_property IOSTANDARD LVCMOS33 [get_ports hdmi_out_sda]
 ## hdmi_out:0.cec
set_property LOC AA4 [get_ports hdmi_out_cec]
set_property IOSTANDARD LVCMOS33 [get_ports hdmi_out_cec]
 ## hdmi_out:0.hdp
set_property LOC AB13 [get_ports hdmi_out_hdp]
set_property IOSTANDARD LVCMOS25 [get_ports hdmi_out_hdp]
...
create_clock -name pix_clk -period 13.468 [get_nets pix_clk]

create_clock -name pix5x_clk -period 2.693 [get_nets pix5x_clk]
...
set_clock_groups -group [get_clocks -include_generated_clocks -of [get_nets sys_clk]] -group [get_clocks -include_generated_clocks -of [get_nets pix_clk]] -asynchronous

set_clock_groups -group [get_clocks -include_generated_clocks -of [get_nets sys_clk]] -group [get_clocks -include_generated_clocks -of [get_nets pix5x_clk]] -asynchronous
...
set_clock_groups -group [get_clocks -include_generated_clocks -of [get_nets pix_clk]] -group [get_clocks -include_generated_clocks -of [get_nets pix5x_clk]] -asynchronous
