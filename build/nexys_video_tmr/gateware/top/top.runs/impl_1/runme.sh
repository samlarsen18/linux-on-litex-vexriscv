...
HD_PWD='/home/slarson/vexriscv/linux-on-litex-vexriscv/build/nexys_video_tmr/gateware/top/top.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nvv_nmr.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nvv_nmr.tcl -notrace
