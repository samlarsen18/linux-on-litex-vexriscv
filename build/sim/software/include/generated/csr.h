...
/* supervisor */
#define CSR_SUPERVISOR_BASE 0xf0002000L
#define CSR_SUPERVISOR_FINISH_ADDR 0xf0002000L
#define CSR_SUPERVISOR_FINISH_SIZE 1
static inline unsigned char supervisor_finish_read(void) {
	unsigned char r = csr_readl(0xf0002000L);
	return r;
}
static inline void supervisor_finish_write(unsigned char value) {
	csr_writel(value, 0xf0002000L);
}
