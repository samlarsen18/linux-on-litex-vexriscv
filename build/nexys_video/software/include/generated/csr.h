...
/* framebuffer */
#define CSR_FRAMEBUFFER_BASE 0xf0005000L
#define CSR_FRAMEBUFFER_CORE_UNDERFLOW_ENABLE_ADDR 0xf0005000L
#define CSR_FRAMEBUFFER_CORE_UNDERFLOW_ENABLE_SIZE 1
static inline unsigned char framebuffer_core_underflow_enable_read(void) {
	unsigned char r = csr_readl(0xf0005000L);
	return r;
}
static inline void framebuffer_core_underflow_enable_write(unsigned char value) {
	csr_writel(value, 0xf0005000L);
}
#define CSR_FRAMEBUFFER_CORE_UNDERFLOW_UPDATE_ADDR 0xf0005004L
#define CSR_FRAMEBUFFER_CORE_UNDERFLOW_UPDATE_SIZE 1
static inline unsigned char framebuffer_core_underflow_update_read(void) {
	unsigned char r = csr_readl(0xf0005004L);
	return r;
}
static inline void framebuffer_core_underflow_update_write(unsigned char value) {
	csr_writel(value, 0xf0005004L);
}
#define CSR_FRAMEBUFFER_CORE_UNDERFLOW_COUNTER_ADDR 0xf0005008L
#define CSR_FRAMEBUFFER_CORE_UNDERFLOW_COUNTER_SIZE 4
static inline unsigned int framebuffer_core_underflow_counter_read(void) {
	unsigned int r = csr_readl(0xf0005008L);
	r <<= 8;
	r |= csr_readl(0xf000500cL);
	r <<= 8;
	r |= csr_readl(0xf0005010L);
	r <<= 8;
	r |= csr_readl(0xf0005014L);
	return r;
}
#define CSR_FRAMEBUFFER_CORE_INITIATOR_ENABLE_ADDR 0xf0005018L
#define CSR_FRAMEBUFFER_CORE_INITIATOR_ENABLE_SIZE 1
static inline unsigned char framebuffer_core_initiator_enable_read(void) {
	unsigned char r = csr_readl(0xf0005018L);
	return r;
}
static inline void framebuffer_core_initiator_enable_write(unsigned char value) {
	csr_writel(value, 0xf0005018L);
}
#define CSR_FRAMEBUFFER_CORE_INITIATOR_HRES_ADDR 0xf000501cL
#define CSR_FRAMEBUFFER_CORE_INITIATOR_HRES_SIZE 2
static inline unsigned short int framebuffer_core_initiator_hres_read(void) {
	unsigned short int r = csr_readl(0xf000501cL);
	r <<= 8;
	r |= csr_readl(0xf0005020L);
	return r;
}
static inline void framebuffer_core_initiator_hres_write(unsigned short int value) {
	csr_writel(value >> 8, 0xf000501cL);
	csr_writel(value, 0xf0005020L);
}
#define CSR_FRAMEBUFFER_CORE_INITIATOR_HSYNC_START_ADDR 0xf0005024L
#define CSR_FRAMEBUFFER_CORE_INITIATOR_HSYNC_START_SIZE 2
static inline unsigned short int framebuffer_core_initiator_hsync_start_read(void) {
	unsigned short int r = csr_readl(0xf0005024L);
	r <<= 8;
	r |= csr_readl(0xf0005028L);
	return r;
}
static inline void framebuffer_core_initiator_hsync_start_write(unsigned short int value) {
	csr_writel(value >> 8, 0xf0005024L);
	csr_writel(value, 0xf0005028L);
}
#define CSR_FRAMEBUFFER_CORE_INITIATOR_HSYNC_END_ADDR 0xf000502cL
#define CSR_FRAMEBUFFER_CORE_INITIATOR_HSYNC_END_SIZE 2
static inline unsigned short int framebuffer_core_initiator_hsync_end_read(void) {
	unsigned short int r = csr_readl(0xf000502cL);
	r <<= 8;
	r |= csr_readl(0xf0005030L);
	return r;
}
static inline void framebuffer_core_initiator_hsync_end_write(unsigned short int value) {
	csr_writel(value >> 8, 0xf000502cL);
	csr_writel(value, 0xf0005030L);
}
#define CSR_FRAMEBUFFER_CORE_INITIATOR_HSCAN_ADDR 0xf0005034L
#define CSR_FRAMEBUFFER_CORE_INITIATOR_HSCAN_SIZE 2
static inline unsigned short int framebuffer_core_initiator_hscan_read(void) {
	unsigned short int r = csr_readl(0xf0005034L);
	r <<= 8;
	r |= csr_readl(0xf0005038L);
	return r;
}
static inline void framebuffer_core_initiator_hscan_write(unsigned short int value) {
	csr_writel(value >> 8, 0xf0005034L);
	csr_writel(value, 0xf0005038L);
}
#define CSR_FRAMEBUFFER_CORE_INITIATOR_VRES_ADDR 0xf000503cL
#define CSR_FRAMEBUFFER_CORE_INITIATOR_VRES_SIZE 2
static inline unsigned short int framebuffer_core_initiator_vres_read(void) {
	unsigned short int r = csr_readl(0xf000503cL);
	r <<= 8;
	r |= csr_readl(0xf0005040L);
	return r;
}
static inline void framebuffer_core_initiator_vres_write(unsigned short int value) {
	csr_writel(value >> 8, 0xf000503cL);
	csr_writel(value, 0xf0005040L);
}
#define CSR_FRAMEBUFFER_CORE_INITIATOR_VSYNC_START_ADDR 0xf0005044L
#define CSR_FRAMEBUFFER_CORE_INITIATOR_VSYNC_START_SIZE 2
static inline unsigned short int framebuffer_core_initiator_vsync_start_read(void) {
	unsigned short int r = csr_readl(0xf0005044L);
	r <<= 8;
	r |= csr_readl(0xf0005048L);
	return r;
}
static inline void framebuffer_core_initiator_vsync_start_write(unsigned short int value) {
	csr_writel(value >> 8, 0xf0005044L);
	csr_writel(value, 0xf0005048L);
}
#define CSR_FRAMEBUFFER_CORE_INITIATOR_VSYNC_END_ADDR 0xf000504cL
#define CSR_FRAMEBUFFER_CORE_INITIATOR_VSYNC_END_SIZE 2
static inline unsigned short int framebuffer_core_initiator_vsync_end_read(void) {
	unsigned short int r = csr_readl(0xf000504cL);
	r <<= 8;
	r |= csr_readl(0xf0005050L);
	return r;
}
static inline void framebuffer_core_initiator_vsync_end_write(unsigned short int value) {
	csr_writel(value >> 8, 0xf000504cL);
	csr_writel(value, 0xf0005050L);
}
#define CSR_FRAMEBUFFER_CORE_INITIATOR_VSCAN_ADDR 0xf0005054L
#define CSR_FRAMEBUFFER_CORE_INITIATOR_VSCAN_SIZE 2
static inline unsigned short int framebuffer_core_initiator_vscan_read(void) {
	unsigned short int r = csr_readl(0xf0005054L);
	r <<= 8;
	r |= csr_readl(0xf0005058L);
	return r;
}
static inline void framebuffer_core_initiator_vscan_write(unsigned short int value) {
	csr_writel(value >> 8, 0xf0005054L);
	csr_writel(value, 0xf0005058L);
}
#define CSR_FRAMEBUFFER_CORE_INITIATOR_BASE_ADDR 0xf000505cL
#define CSR_FRAMEBUFFER_CORE_INITIATOR_BASE_SIZE 4
static inline unsigned int framebuffer_core_initiator_base_read(void) {
	unsigned int r = csr_readl(0xf000505cL);
	r <<= 8;
	r |= csr_readl(0xf0005060L);
	r <<= 8;
	r |= csr_readl(0xf0005064L);
	r <<= 8;
	r |= csr_readl(0xf0005068L);
	return r;
}
static inline void framebuffer_core_initiator_base_write(unsigned int value) {
	csr_writel(value >> 24, 0xf000505cL);
	csr_writel(value >> 16, 0xf0005060L);
	csr_writel(value >> 8, 0xf0005064L);
	csr_writel(value, 0xf0005068L);
}
#define CSR_FRAMEBUFFER_CORE_INITIATOR_LENGTH_ADDR 0xf000506cL
#define CSR_FRAMEBUFFER_CORE_INITIATOR_LENGTH_SIZE 4
static inline unsigned int framebuffer_core_initiator_length_read(void) {
	unsigned int r = csr_readl(0xf000506cL);
	r <<= 8;
	r |= csr_readl(0xf0005070L);
	r <<= 8;
	r |= csr_readl(0xf0005074L);
	r <<= 8;
	r |= csr_readl(0xf0005078L);
	return r;
}
static inline void framebuffer_core_initiator_length_write(unsigned int value) {
	csr_writel(value >> 24, 0xf000506cL);
	csr_writel(value >> 16, 0xf0005070L);
	csr_writel(value >> 8, 0xf0005074L);
	csr_writel(value, 0xf0005078L);
}
#define CSR_FRAMEBUFFER_CORE_DMA_DELAY_BASE_ADDR 0xf000507cL
#define CSR_FRAMEBUFFER_CORE_DMA_DELAY_BASE_SIZE 4
static inline unsigned int framebuffer_core_dma_delay_base_read(void) {
	unsigned int r = csr_readl(0xf000507cL);
	r <<= 8;
	r |= csr_readl(0xf0005080L);
	r <<= 8;
	r |= csr_readl(0xf0005084L);
	r <<= 8;
	r |= csr_readl(0xf0005088L);
	return r;
}
static inline void framebuffer_core_dma_delay_base_write(unsigned int value) {
	csr_writel(value >> 24, 0xf000507cL);
	csr_writel(value >> 16, 0xf0005080L);
	csr_writel(value >> 8, 0xf0005084L);
	csr_writel(value, 0xf0005088L);
}
#define CSR_FRAMEBUFFER_DRIVER_CLOCKING_MMCM_RESET_ADDR 0xf000508cL
#define CSR_FRAMEBUFFER_DRIVER_CLOCKING_MMCM_RESET_SIZE 1
static inline unsigned char framebuffer_driver_clocking_mmcm_reset_read(void) {
	unsigned char r = csr_readl(0xf000508cL);
	return r;
}
static inline void framebuffer_driver_clocking_mmcm_reset_write(unsigned char value) {
	csr_writel(value, 0xf000508cL);
}
#define CSR_FRAMEBUFFER_DRIVER_CLOCKING_MMCM_READ_ADDR 0xf0005090L
#define CSR_FRAMEBUFFER_DRIVER_CLOCKING_MMCM_READ_SIZE 1
static inline unsigned char framebuffer_driver_clocking_mmcm_read_read(void) {
	unsigned char r = csr_readl(0xf0005090L);
	return r;
}
static inline void framebuffer_driver_clocking_mmcm_read_write(unsigned char value) {
	csr_writel(value, 0xf0005090L);
}
#define CSR_FRAMEBUFFER_DRIVER_CLOCKING_MMCM_WRITE_ADDR 0xf0005094L
#define CSR_FRAMEBUFFER_DRIVER_CLOCKING_MMCM_WRITE_SIZE 1
static inline unsigned char framebuffer_driver_clocking_mmcm_write_read(void) {
	unsigned char r = csr_readl(0xf0005094L);
	return r;
}
static inline void framebuffer_driver_clocking_mmcm_write_write(unsigned char value) {
	csr_writel(value, 0xf0005094L);
}
#define CSR_FRAMEBUFFER_DRIVER_CLOCKING_MMCM_DRDY_ADDR 0xf0005098L
#define CSR_FRAMEBUFFER_DRIVER_CLOCKING_MMCM_DRDY_SIZE 1
static inline unsigned char framebuffer_driver_clocking_mmcm_drdy_read(void) {
	unsigned char r = csr_readl(0xf0005098L);
	return r;
}
#define CSR_FRAMEBUFFER_DRIVER_CLOCKING_MMCM_ADR_ADDR 0xf000509cL
#define CSR_FRAMEBUFFER_DRIVER_CLOCKING_MMCM_ADR_SIZE 1
static inline unsigned char framebuffer_driver_clocking_mmcm_adr_read(void) {
	unsigned char r = csr_readl(0xf000509cL);
	return r;
}
static inline void framebuffer_driver_clocking_mmcm_adr_write(unsigned char value) {
	csr_writel(value, 0xf000509cL);
}
#define CSR_FRAMEBUFFER_DRIVER_CLOCKING_MMCM_DAT_W_ADDR 0xf00050a0L
#define CSR_FRAMEBUFFER_DRIVER_CLOCKING_MMCM_DAT_W_SIZE 2
static inline unsigned short int framebuffer_driver_clocking_mmcm_dat_w_read(void) {
	unsigned short int r = csr_readl(0xf00050a0L);
	r <<= 8;
	r |= csr_readl(0xf00050a4L);
	return r;
}
static inline void framebuffer_driver_clocking_mmcm_dat_w_write(unsigned short int value) {
	csr_writel(value >> 8, 0xf00050a0L);
	csr_writel(value, 0xf00050a4L);
}
#define CSR_FRAMEBUFFER_DRIVER_CLOCKING_MMCM_DAT_R_ADDR 0xf00050a8L
#define CSR_FRAMEBUFFER_DRIVER_CLOCKING_MMCM_DAT_R_SIZE 2
static inline unsigned short int framebuffer_driver_clocking_mmcm_dat_r_read(void) {
	unsigned short int r = csr_readl(0xf00050a8L);
	r <<= 8;
	r |= csr_readl(0xf00050acL);
	return r;
}
